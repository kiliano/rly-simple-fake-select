...
jQuery(document).ready(function() {
	...
	RlySimpleFakeSelect("."+rlySimplePrefix+'-select');
})
...
function RlySimpleFakeSelect(e) {
	...
	// Clicking on fake
	$(e).next("."+rlySimplePrefix+"-fake-select").find("."+rlySimplePrefix+"-fake-link").click(function(){
	...
	$(e).next("."+rlySimplePrefix+"-fake-select").find("."+rlySimplePrefix+"-fake-options li > a").click(function(){
